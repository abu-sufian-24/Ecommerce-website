...
function Product() {
  ...
  return (
    <div className="container mt-12 mb-12 px-4 sm:px-0 dark:bg-gray-900 dark:text-white overflow-x-hidden">
      <div className="text-center" data-aos="fade-down">
        <p className="text-green-400 text-sm">Top Selling Products for you</p>
