...
function FashionProductsPage({ onShowFashoin, showFashion }) {
      ...
      {showFashion && (
        <>
          ...
          <div className="text-center">
            <button onClick={() => onShowFashoin()} className="mt-6 cursor-pointer bg-red-600 text-white py-2 px-6 rounded-md hover:bg-red-500 transition-all duration-200">
              Close
            </button>
          </div>
        </>
...
export default FashionProductsPage;
